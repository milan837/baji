...
public class OnboardingBajiListRecyclerViewAdapter extends RecyclerView.Adapter<OnboardingBajiListRecyclerViewAdapter.MyViewHolder> {
    Context context;
    List<OnboardBaji> list;

    public OnboardingBajiListRecyclerViewAdapter(Context context, List<OnboardBaji> list) {
