...
public class OtpFragmentRepositiory {

    Context context;
    OptFragmentContract.Presenter presenter;

    public OtpFragmentRepositiory(Context context, OptFragmentContract.Presenter presenter) {
